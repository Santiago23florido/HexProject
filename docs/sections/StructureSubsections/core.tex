...
Player (classe) & HumanPlayer, AIPlayer, HybridPlayer & Joueur de base et identité. \\
IMoveStrategy (classe) & RandomStrategy, MonteCarloStrategy, NegamaxStrategy & Interface de sélection de coups. \\
NegamaxStrategy (classe) & NegamaxHeuristicStrategy, NegamaxGnnStrategy & Stratégie Negamax avec évaluation et recherche. \\
Zobrist (classe) &  & Hashing du plateau pour tables de transposition. \\
\hline
